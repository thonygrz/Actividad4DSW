...
describe('prueba6', function () {
    ...
    it('prueba6', async function () {
        ...
        await driver.wait(until.elementLocated(By.css("div:nth-child(2) > .mb-2 .v-icon")), 10000)
        await driver.findElement(By.css("div:nth-child(2) > .mb-2 .v-icon")).click()
