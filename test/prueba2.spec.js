...
describe('prueba2', function () {
    ...
    it('prueba2', async function () {
        ...
        await driver.findElement(By.id("input-115")).click()

        await driver.wait(until.elementLocated(By.id("input-112")), 20000)
        await driver.findElement(By.id("input-115")).sendKeys(Key.chord(Key.CONTROL, "a"), "8.00");
